	...
	<div id="main">
		<div id="search2">
			<div id="searchleft">
				...
				网站路径：<a href="item_search.html">商品搜索</a>&gt;&gt;<a href="">搜索结果</a>
			</div>
						<div id="searchright2">
			...
			<div id="sendnotecontent">
				...
				<tbody>
				  <tr>
					...
					<td>
						<a href="item_info.html"><img src="../image/dxwl4.jpg" class="picture1"/></a>
					</td>
					<td>
		...
		<a href="favorite.html"><img src="../image/put_to_collection.gif" alt="收藏" class="picture"></a>
					...
					<td>
						<a href="item_info_nostorage.html"><img src="../image/dxwl2.jpg" class="picture1"/></a>
					</td>
					<td>
