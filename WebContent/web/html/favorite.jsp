	...
	<div id="main">
		<div id="search2">
			<div id="searchleft">
				...
				网站路径：<a href="home.html">首页</a>&gt;&gt;<a href="">收藏夹</a>
			</div>
			<div id="searchright2">
			...
			<div id="sendnotecontent">
				...
				<tbody>
				  <tr>
					...
					<td>
						<a href="item_info.html"><span>大学物理学.第四册：波动与光学（第2版）</span></a>
					</td>
					<td>
					...
					<td>
						<a href="cart_list.html"><img src="../image/put_to_cart.gif" class="picture"/></a>&nbsp;<a href="#" onClick="window.confirm('确定删除？')"><img src="../image/delete_item.gif" class="picture" /></a>
					</td>
          		  </tr>
				  <tr>
            		<td>
					...
					<td>
						<a href="item_info_nostorage.html"><span>大学物理学.第二册：热学（第2版）</span></a>
					</td>
					<td>
