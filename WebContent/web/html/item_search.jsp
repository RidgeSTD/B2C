	...
	<div id="main">
		<div id="search2">
			<div id="searchleft">
				...
				网站路径：<a href="home.html">首页</a>&gt;&gt;<a href="">商品搜索</a>
			</div>
			<div id="searchright2">
		...
		<div id="sendnote">
			...
			<div id="sendnotecontent">
				<table id="itemsearch">
				 ...
				 <tr>
				 <th></th>
				 	<td><input type="button" class="" name="button2" value="搜索" onClick="javascript:window.location.href='item_search_list.html'">
				 </tr>
        </table>
